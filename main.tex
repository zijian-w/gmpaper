...
\newcommand{\hccultra}{\textsc{HccUltraFit}\xspace}
...
We demonstrate our computational pipeline using real-world congressional redistricting data from Connecticut.
\end{abstract}
