...
To reduce redundancy among words while maintaining coverage, we apply a two-stage greedy set-cover approximation with a smaller threshold $\tau'=\eta\tau$ and a coverage threshold $\tau$.
We illustrate our pipeline using real-world examples from Connecticut and North Carolina
