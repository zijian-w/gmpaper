...
\begin{figure}[!htbp]
    ...
    \caption{iso calibration}
    \label{fig:iso_calibration}
\end{figure}
We run our pipeline for $\gamma$ from $0$ to $1$ and compare the spectral gap of the flux matrix. For each $\gamma$, we use two independent runs to show consistency.
\FloatBarrier
\begin{figure}[!htbp]
    \centering
    \includegraphics[width=1.0\linewidth]{figures/spectral_gap_two_seeds.png}
    \caption{spectral gap two seeds}
    \label{fig:spectral_gap_two_seeds}
\end{figure}
